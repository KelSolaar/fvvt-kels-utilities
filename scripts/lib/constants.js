const Constants = {
    ...
    equipmentQuality: [{
        ...
        },
        {
            ...
            description: "Price multiplier for a \"low quality, poorly made, high use\" looted item.",
            priceMultiplier: 0.5,
            range: [6, 55]
        },
        {
            name: "Terrible Quality, Cracked, Warped",
            description: "Price multiplier for a \"terrible quality, cracked, warped\" looted item.",
            priceMultiplier: 0.1,
            range: [56, 65]
        },
        {
